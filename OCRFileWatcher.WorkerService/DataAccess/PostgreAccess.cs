...
namespace OCRFileWatcher.WorkerService.DataAccess
{
    ...
    {
        private readonly ILogger<PostgreAccess> _logger;
        private readonly AppSetting _appSetting;

        public PostgreAccess(ILogger<PostgreAccess> logger, IOptions<AppSetting> appSetting)
        {
            _logger = logger;
        ...
        public List<PayerDetail> GetPayerDetails(string admissionNumber)
        {
            ...
            try
            {
                using (var cnn = new NpgsqlConnection(_appSetting.MyDB))
                {
                    // Open the connection
                    cnn.Open();
